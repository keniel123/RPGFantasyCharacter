...
namespace RPGController
{
    public class SessionManager : MonoBehaviour
    {
        ...
        GameObject cameraHolderActual;

        public void InitGame() {
            Transform sp = LevelManager.Instance.spawnPosition;
            playerController = Instantiate(playerControllerPrefab, sp.position, sp.rotation) as GameObject;
            cameraHolderActual = Instantiate(cameraHolderPrefab, sp.position, sp.rotation) as GameObject;

            //After loading the level scene, assign pickable items
            PickableItemsManager pickItemManager = playerController.GetComponent<PickableItemsManager>();
            pickItemManager.worldInteractions.AddRange(LevelManager.Instance.worldInteractions);
